package com.application.melanieh.kk.com.application.kk.customviews;
...
/**
 * Created by melanieh on 2/6/18.
 *
 * code courtesy of https://github.com/Gnod/ParallaxListView.git
 */

public class ZoomOutPullDownAnimation extends ImageView {
    ...
    public ZoomOutPullDownAnimation(Context context, AttributeSet attrs,
                                 int defStyle) {
    ...
    public ZoomOutPullDownAnimation(Context context) {
        super(context);
        init(context);
    }
